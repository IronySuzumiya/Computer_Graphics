...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Scene Roaming", NULL, NULL);
    if (window == NULL)
    {
    ...
    // ------------------------------------
    Shader ourShader("resources/shaders/shader.v.s", "resources/shaders/shader.f.s");
    ...
    float vertices[] = {
        ...
        -0.5f, -0.408f,  0.433f,  0.0f,  0.0f,
         0.5f, -0.408f,  0.433f,  1.0f,  0.0f,
         0.0f, -0.408f, -0.433f,  0.5f,  1.0f,

        -0.5f, -0.408f,  0.433f,  0.0f,  0.0f,
         0.5f, -0.408f,  0.433f,  1.0f,  0.0f,
         0.0f,  0.408f,  0.144f,  0.5f,  1.0f,

        -0.5f, -0.408f,  0.433f,  0.0f,  0.0f,
         0.0f, -0.408f, -0.433f,  1.0f,  0.0f,
         0.0f,  0.408f,  0.144f,  0.5f,  1.0f,
    ...
    // -------------------------
    unsigned int texture_floor, texture_container;
    // texture 1
    // ---------
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(0.5f, 0.408f, 1.0f));
